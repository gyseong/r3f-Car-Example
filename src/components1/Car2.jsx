...
Command: npx gltfjsx@6.2.8 public/models/lamborghini_-_ferzor/scene.gltf -o src/components1/Car2.jsx -r public
...
export function Car2(props) {
  const { nodes, materials } = useGLTF('/models/lamborghini_-_ferzor/scene.gltf')
  return (
